...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Post("/api/alerts/evaluate-alert", bind(dtos.EvaluateAlertRequestCommand{}), Wrap(EvaluateAlert))        // LOGZ.IO GRAFANA CHANGE :: DEV-17927 - alerts endpoint
	r.Post("/api/alerts/evaluate-alert-by-id", bind(dtos.EvaluateAlertByIdCommand{}), Wrap(EvaluateAlertById)) // LOGZ.IO GRAFANA CHANGE :: DEV-17927 - alerts endpoint
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Group("/alerts", func(alertsRoute routing.RouteRegister) {
			alertsRoute.Post("/evaluate-alert", bind(dtos.EvaluateAlertRequestCommand{}), Wrap(EvaluateAlert)) // LOGZ.IO GRAFANA CHANGE :: DEV-17927 - alerts endpoint
