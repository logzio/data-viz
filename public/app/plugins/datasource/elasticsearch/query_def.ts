...
// LOGZ.IO GRAFANA CHANGE :: DEV-18135 add rate function to metric aggregation types
// @ts-ignore
const derivativeAggIndex = metricAggTypes.findIndex(aggType => aggType.text === 'Derivative');
const rateMetric = {
  text: 'Rate',
  value: 'rate',
  requiresField: true,
...
metricAggTypes.splice(derivativeAggIndex + 1, 0, rateMetric);
